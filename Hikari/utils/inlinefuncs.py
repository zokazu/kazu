...
from Hikari import arq
from Hikari.services.keyboard import Ikb
from Hikari.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from Hikari.services.tasks import _get_tasks_text, all_tasks, rm_task
from Hikari.services.types import InlineQueryResultCachedDocument
from Hikari.modules.info import get_chat_info, get_user_info
from Hikari.modules.music import download_youtube_audio
from Hikari.utils.functions import test_speedtest
from Hikari.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/HikariBot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[ᴘʀɪᴍᴇ ᴍᴇɢᴀ](https://t.me/HikariManageRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
